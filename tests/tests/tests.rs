...
// use myox_kvs::KvStore;
// use predicates::str::contains;
// use std::process::Command;

// use assert_cmd::prelude::*;
// use myox_kvs::{KVSResult as Result, KvStore};
...
//     // let s = std::fs::read_to_string(temp_dir.path().join("1.log"))?;
//     // println!("{}", s);
//     drop(store);
...
//         .success()
//         .stdout(is_empty());
//     // let s = std::fs::read_to_string(temp_dir.path().join("2.log"))?;
//     // println!("{}", s);

//     // for (i, entry) in std::fs::read_dir(&temp_dir)?.enumerate() {
//     //     let dir = entry?;
//     //     println!("{:?}", dir.path());
//     //     let s = std::fs::read_to_string(dir.path())?;
//     //     println!("{}", s);
//     // }
